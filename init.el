...
(fset 'arrange-windows-2-1-3-kbd-macro
   (kmacro-lambda-form [?\M-x ?o ?r ?g ?- ?a ?g ?e ?n ?d ?a ?- ?l ?i ?s ?t return ?\C-x ?o ?\C-x ?3 ?\C-u ?2 ?3 ?\C-x ?\} ?\C-x ?o ?2 ?\C-u ?\C-x ?o ?3 ?\C-x ?o ?2 ?\M-: ?\( ?s ?e ?t ?- ?w ?i ?n ?d ?o ?w ?- ?d ?e ?d ?i ?c ?a ?t ?e ?d ?- ?p ?  ?\( ?s ?e ?l ?e ?c ?t ?e ?d ?- ?w ?i ?n ?d ?o ?w ?\C-f ?  ?t return ?\C-x ?o ?1] 0 "%d"))

(defun arrange-windows-2-1-3 ()
  (interactive)
  (org-agenda-list)
...
(use-package lsp-mode
  ...
  ;;                                              (remq 'company-capf company-backends))))) ;; Yas 
)
...
(use-package org-transclusion
  ...
  :bind (("C-c t" . org-transclusion-add)
         ("C-c C-x C-e" . org-transclusion-mode)))
...
;;   :load-path "site-lisp/mdx-dictionary")
